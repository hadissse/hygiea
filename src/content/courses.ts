...
export const ASTRO_KNOWLEDGE: { id: string; title: string; subtitle: string; svgKey: string | null; icon: string; courseId: string; href: string }[] = [
  { id: 'sun-sign', title: 'برجك الشمسي', subtitle: 'جوهر هويّتك', svgKey: 'sun', icon: '◉', courseId: 'natal-chart-basics', href: '/الكواكب/الشمس' },
  { id: 'moon-sign', title: 'برجك القمري', subtitle: 'حياتك العاطفية', svgKey: 'moon', icon: '◌', courseId: 'natal-chart-basics', href: '/الكواكب/القمر' },
  { id: 'rising-sign', title: 'طالعك', subtitle: 'كيف يراك العالم', svgKey: null, icon: '↑', courseId: 'natal-chart-basics', href: '/المعرفة/الخريطة-الفلكية-astrology' },
  { id: 'houses', title: 'البيوت الاثنا عشر', subtitle: 'مساحات حياتك', svgKey: null, icon: '▦', courseId: 'twelve-houses', href: '/البيوت/البيوت-الفلكية' },
  { id: 'elements', title: 'العناصر الأربعة', subtitle: 'نارك وترابك وهواؤك وماؤك', svgKey: null, icon: '◈', courseId: 'four-elements', href: '/العناصر/العناصر-الأربعة' },
  { id: 'transits', title: 'العبورات الحية', subtitle: 'السماء الآن وخريطتك', svgKey: 'saturn', icon: '◎', courseId: 'reading-transits', href: '/المدونة/الخريطة-السنوية-الفلكية' },
  { id: 'saturn-return', title: 'عودة زحل', subtitle: 'عتبة الثلاثين', svgKey: 'saturn', icon: '◎', courseId: 'saturn-return', href: '/الكواكب/زحل' },
  { id: 'moon-phases', title: 'أطوار القمر', subtitle: 'إيقاع شهري تعيشه', svgKey: 'moon', icon: '◌', courseId: 'moon-cycles', href: '/الكواكب/القمر' },
  { id: 'twelve-signs', title: 'البروج الاثنا عشر', subtitle: 'طاقة كل برج وصفاته', svgKey: null, icon: '◇', courseId: 'twelve-signs', href: '/الأبراج/الأبراج-الفلكية' },
  { id: 'aspects', title: 'الجوانب الفلكية', subtitle: 'لغة الزوايا في خريطتك', svgKey: null, icon: '×', courseId: 'aspects-deep', href: '/الجوانب/الجوانب-الفلكية' },
  { id: 'chiron', title: 'كيرون', subtitle: 'الجرح الذي يُعلّم', svgKey: 'chiron', icon: '◎', courseId: 'chiron-wound', href: '/الكواكب/كايرون' },
  { id: 'mercury-rx', title: 'عطارد الراجع', subtitle: 'فرصة المراجعة', svgKey: 'mercury', icon: '◎', courseId: 'mercury-retrograde', href: '/الكواكب/عطارد' },
];
