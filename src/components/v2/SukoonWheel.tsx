...
export function defaultSukoonWheel(): WheelChart {
  return {
    ...
    mcLon: 294,
    planets: [
      { name: 'Sun',   key: 'sun',       lon: 287 },
      { name: 'Moon',   key: 'moon',      lon: 203 },
      { name: 'Mercury',   key: 'mercury',   lon: 264 },
      { name: 'Venus',  key: 'venus',     lon: 300, isRetrograde: true },
      { name: 'Mars',  key: 'mars',      lon: 316 },
      { name: 'Jupiter', key: 'jupiter',   lon: 323 },
      { name: 'Saturn',     key: 'saturn',    lon:  13, isRetrograde: true },
      { name: 'Uranus', key: 'uranus',    lon: 215, isRetrograde: true },
      { name: 'Neptune',   key: 'neptune',   lon: 299 },
      { name: 'Pluto',   key: 'pluto',     lon: 189, isRetrograde: true },
      { name: 'North Node', key: 'northNode', lon: 124, isRetrograde: true },
    ],
  };
}
