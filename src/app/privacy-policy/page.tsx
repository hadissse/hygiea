          ...
          <div className="text-ink leading-[1.85] space-y-10">
            ...
            <section id="collect">
              ...
              <ul className="list-disc list-inside text-ink-muted space-y-2">
                ...
                <li><strong>Cloudflare Turnstile:</strong> Browser signals used for bot-detection during account registration; governed by Cloudflare's own Privacy Policy</li>
              </ul>
            </section>
              ...
              <div className="mt-4 space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    data: 'Browser signals during signup',
                    region: 'Global edge network',
                    link: 'https://www.cloudflare.com/privacypolicy/',
                  },
                  {
            ...
            <section id="security">
              ...
              <ul className="list-disc list-inside text-ink-muted mt-3 space-y-2">
                ...
                <li><strong>CAPTCHA protection:</strong> Cloudflare Turnstile on account registration to prevent automated abuse</li>
