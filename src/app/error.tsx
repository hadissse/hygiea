...
export default function GlobalError({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-5 text-center gap-5" dir="ltr">
      ...
      <div className="font-serif text-xl text-ink">Something went wrong</div>
      <div className="text-sm text-ink-muted">We couldn't load this page.</div>
      <button
        onClick={reset}
