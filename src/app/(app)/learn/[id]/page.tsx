...
export default function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="px-5 pt-4 pb-28 md:px-8 md:pb-16">
      {/* top bar */}
      ...
      <div className="md:max-w-5xl md:mx-auto md:grid md:grid-cols-[380px_1fr] md:gap-10 md:items-start md:pt-6">
        {/* left col: poster (sticky on desktop) */}
        <div className="mt-3 md:mt-0 md:sticky md:top-6 md:self-start">
          <CoursePoster title={course.title} course={course.course} variant={course.variant} />
        </div>

        {/* right col: tabs + content + CTA */}
        <div>
          {/* tab switch */}
